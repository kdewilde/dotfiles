...
alias codec="code ~/myprojects/ceres/ceres-web/ceres-web-fe/integration/WAR/src/main/webapp/js/ext6"
...
alias codevp="code ~/myprojects/vectoring-platform/vectoring-platform/integration/war/src/main/webapp"
